...
- [LWCite-2002] Javed et al., "A comprehensive survey on computer forensics", IEEE Access, 2022 — source of the FSM formula (Equation 1) and its per-domain toolkit feature comparisons.
