...
- [LWCite-2045] Wang, "Self-supervised CLIP-based image recognition and analysis for electronic data forensics", IEEE Access, 2026 — source of the cross-attention architecture, self-supervised tasks, and four-dataset benchmark described above.
