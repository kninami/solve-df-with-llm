...
- [DFCite-2017] Shin and Moon, "Cloud database forensics in practice: Structural challenges and investigative lessons from Azure SQL Database", IEEE Access, 2025 — source of the fn_dblog-based recovery method and the comparative structural-applicability findings described above.
