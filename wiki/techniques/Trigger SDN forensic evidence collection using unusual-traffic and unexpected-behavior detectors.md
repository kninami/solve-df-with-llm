...
- [LWCite-2003] Jiménez et al., "A filtering model for evidence gathering in an SDN-oriented digital forensic and incident response context", IEEE Access, 2024 — source of the dual-detector filtering intelligence model and its evaluation metrics.
