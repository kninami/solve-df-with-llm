...
- [LWCite-2015] Rizvi et al., "Application of artificial intelligence to network forensics: Survey, challenges and future directions", IEEE Access, 2022 — source of the AI-based network forensics technique survey summarized above.
