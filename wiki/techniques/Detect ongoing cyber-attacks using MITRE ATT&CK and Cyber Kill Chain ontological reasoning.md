...
- [DFCite-2034] Dimitriadis et al., "Fronesis: Digital forensics-based early detection of ongoing cyber-attacks", IEEE Access, 2023 — source of the Fronesis ontology, COSP detection methodology, and email phishing worked example described above.
