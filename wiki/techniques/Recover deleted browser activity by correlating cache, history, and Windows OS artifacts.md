...
- [LWCite-2055] Berham and Morris, "A critical comparison of Brave Browser and Google Chrome forensic artefacts", Journal of Digital Forensics, Security and Law, 2022 — source of the cross-artifact correlation methodology and the DogLeft.png case example described above.
