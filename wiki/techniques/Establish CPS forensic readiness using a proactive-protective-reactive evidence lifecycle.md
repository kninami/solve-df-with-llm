...
- [DFCite-2019] K et al., "Cyber physical systems security: Bridging privacy, verification, intelligence, and forensics", IEEE Access, 2026 — source of the three-phase forensic readiness lifecycle and provenance-tracking architecture summarized above.
