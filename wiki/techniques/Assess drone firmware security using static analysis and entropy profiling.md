...
- [LWCite-2054] Salamh et al., "A constructive DIREST security threat modeling for drone as a service", Journal of Digital Forensics, Security and Law, 2021 — source of the firmware unpacking/strings/entropy methodology and the Zino Hubsan case-study results described above.
