...
- [LWCite-2004] Alotibi, "A high abstract digital forensic readiness metamodel for securing smart cities", IEEE Access, 2024 — source of the HADFRM metamodel, its literature-integration methodology, and the smart-home isolation-model worked example.
