...
- [LWCite-2047] Gopinathan and Shanmugam, "Synchrophasor forensics: Tracking spatiotemporal anomalies and diagnosing grid frequency events with machine learning for enhanced situational awareness", IEEE Access, 2024 — source of the SPEDA/SPEDI methodology and ML classifier benchmark described above.
