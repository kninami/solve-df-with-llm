...
- [DFCite-2011] Kao, "Accelerating multilingual cryptocurrency forensics: An NLP-driven approach for efficient mnemonic identification", IEEE Access, 2025 — source of the TextCNN mnemonic-identification model, dataset, and benchmark results described above.
