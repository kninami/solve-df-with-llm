...
- [LWCite-2049] Al-Fehani et al., "TFD-Video: Threshold-aware federated deepfake detection for video forensics", IEEE Access, 2026 — source of the TFD threshold-gated sparsity mechanism and its communication/accuracy benchmark results described above.
