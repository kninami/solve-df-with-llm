...
- [DFCite-2031] Oh et al., "Forensic detection of timestamp manipulation for digital forensic investigation", IEEE Access, 2024 — source of the $LogFile-1A/$UsnJrnl-1A detection algorithms, the file-system-tunneling identification method, and the APT malware evaluation results described above.
