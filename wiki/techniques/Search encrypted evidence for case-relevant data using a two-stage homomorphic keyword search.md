...
- [LWCite-2018] Ogunseyi and Adedayo, "Cryptographic techniques for data privacy in digital forensics", IEEE Access, 2023 — source of the PPDF conceptual model, its four-stage process, and its cryptographic-technique comparison summarized above.
