...
- [LWCite-2016] dos Santos et al., "ChaSAM: An architecture based on perceptual hashing for image detection in computer forensics", IEEE Access, 2024 — source of the chHash/domiHash algorithms, the two-iteration pairing scheme, and the evaluation results described above.
