...
- [LWCite-2039] Thomas-Brans et al., "New diagnostic forensic protocol for damaged secure digital memory cards", IEEE Access, 2022 — source of the decision-diagram protocol, the infrared thermal analysis technique, and the real case study described above.
