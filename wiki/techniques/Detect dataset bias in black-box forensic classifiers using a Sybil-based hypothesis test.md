...
- [DFCite-2042] Mostafa et al., "Exploring the pitfalls of black boxes in media forensics: A case study in source camera identification", IEEE Access, 2025 — source of the Sybil methodology, DER/CER/NFD metrics, and color-distance-classifier comparison described above.
