...
- [DFCite-2006] Kao et al., "A local hierarchical LLM framework for privacy-preserving memory forensics of cryptocurrency wallets", IEEE Access, 2026 — source of the Tri-Layer RAG-Decider architecture, evidence-extraction rule library, and dual-track evaluation results.
