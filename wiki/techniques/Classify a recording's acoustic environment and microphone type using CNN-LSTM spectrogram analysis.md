...
- [LWCite-2022] Qamhan et al., "Digital audio forensics: Microphone and environment classification using deep learning", IEEE Access, 2021 — source of the unvoiced-segment CRNN spectrogram classification method and its KSU-DB evaluation results.
