...
- [DFCite-2027] Şen and Artuner, "Emulator Forensics Investigation Model (EFIM)", IEEE Access, 2025 — source of the nine-phase EFIM model, the EFT tool architecture, and the cross-platform validation results described above.
