...
- [LWCite-2032] Oh et al., "Forensic recovery of file system metadata for digital forensic investigation", IEEE Access, 2022 — source of the record-carving recovery method, the 12-scenario evaluation, and the MV Sewol case study described above.
