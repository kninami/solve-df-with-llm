...
- [DFCite-2023] Al-Dhaqm et al., "Digital forensics subdomains: The state of the art and future directions", IEEE Access, 2021 — source of the DFM three-level metamodel, its six-step construction methodology, and the database-compromise worked example described above.
