...
- [LWCite-2044] Singh et al., "Secure storage model for digital forensic readiness", IEEE Access, 2022 — source of the four-process SecureRS model, its NIST CFTT-aligned validation, and performance benchmarks described above.
