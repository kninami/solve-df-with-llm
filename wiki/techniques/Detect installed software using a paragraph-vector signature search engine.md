...
- [DFCite-2021] Soltani et al., "Developing software signature search engines using paragraph vector model: A triage approach for digital forensics", IEEE Access, 2021 — source of the forensic differential analysis signature construction and S3E doc2vec search engine described above.
