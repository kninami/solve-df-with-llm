...
- [LWCite-2052] Sarhan et al., "VoIP network forensics of instant messaging calls", IEEE Access, 2024 — source of the STUN-based correlation methodology, CDR extraction process, and evaluation results described above.
