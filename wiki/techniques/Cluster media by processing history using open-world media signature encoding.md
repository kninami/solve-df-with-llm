...
- [DFCite-2051] Baracchi et al., "Toward open-world multimedia forensics through media signature encoding", IEEE Access, 2024 — source of the media signature encoder architecture, quadruplet loss, and media4provider/media4community evaluation results described above.
