...
- [LWCite-2048] Chang and Echizen, "Tell-tale watermarks for explanatory reasoning in synthetic media forensics", IEEE Access, 2026 — source of the three tell-tale watermark designs, the encoder/decoder architecture, and the explanatory reasoning methodology and benchmark results described above.
