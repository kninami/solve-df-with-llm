...
- [LWCite-2007] Ali et al., "A meta-heuristic method for reassemble bifragmented intertwined JPEG image files in digital forensic investigation", IEEE Access, 2023 — source of the MHRI three-rule method and its DFRWS-dataset evaluation results.
