...
- [DFCite-2035] Manivannan and Amalanathan, "GeoForensic-AI: A lightweight and explainable forensic AI framework for modern digital ecosystems", IEEE Access, 2026 — source of the seven-layer architecture, BN-TGNN causal-graph fusion methodology, and healthcare deployment scenario summarized above.
