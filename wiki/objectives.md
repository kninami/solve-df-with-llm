...
This page is the fixed objective hub for the SOLVE-IT LLM wiki.
Objectives are maintained here as a single navigation page rather than as separate entity pages.
...
Process data to extract artifacts from specific data formats.

- Sort order: 13

## DFO-1023 Extract specific artifact types

Process data to extract specific types of artifact.
