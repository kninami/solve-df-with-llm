...
- [DFCite-2009] Hakim et al., 2023 — the paper's own Chain of Artifacts design already supports correlation links between phases (via shared timestamps, IPs, and processes), which this mitigation extends to explicitly cover artifacts genuinely relevant to multiple DBB phases.
