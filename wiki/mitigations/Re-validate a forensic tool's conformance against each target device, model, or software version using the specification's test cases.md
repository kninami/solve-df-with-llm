...
- [DFCite-2058] Khalid & Qadir, 2022, "An Evaluation Framework For Digital Image Forensics Tools", JDFSL 17(4). Provides the analogous DIFT requirements/assertions/test-case methodology for image forensics tools, and its own conclusion that best features across tools "can also be combined" and gaps should be documented per tool.
