...
- [LWCite-2005] Abbasi et al., 2022 — the paper's own per-scene, per-classifier tables (Tables 4-6) provide the environment-specific benchmark data this mitigation relies on.
