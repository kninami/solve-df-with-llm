...
- [DFCite-1185] Park et al., 2021, "Energy-based linear PCM audio recovery method of impaired MP4 file stored in dashboard camera memory", FSI: Digital Investigation 39. States that the recovery method's working hypotheses (48 kHz, mono, 2-byte depth) must be generalized beyond the study's dataset and are obtained in advance from a normal MP4 file.
