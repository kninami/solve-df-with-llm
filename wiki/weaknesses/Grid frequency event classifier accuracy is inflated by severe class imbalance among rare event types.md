...
- [LWCite-2047] Gopinathan and Shanmugam, 2024 — Table 6 reports the per-class event counts discussed above, and the paper's own "Results" discussion explicitly acknowledges that accuracy alone does not capture class-distribution effects in imbalanced datasets.
