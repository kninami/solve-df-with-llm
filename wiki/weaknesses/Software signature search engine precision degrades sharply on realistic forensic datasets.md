...
- [LWCite-2021] Soltani et al., 2021 — Section V.C.2 and Figure 8 report M57-machine precision in the approximate range 0.52-0.63, well below the 0.795-0.82 range measured on controlled machines (Section V.C.1, Figure 4).
