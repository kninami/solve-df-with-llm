...
- [LWCite-2039] Thomas-Brans et al., 2022 — Section V "Discussion" explicitly classifies infrared analysis as invasive due to the power-on requirement, and Section III.B.2 details the two possible (safe-stabilizing vs. damage-risking) temperature-rise outcomes observed during infrared diagnosis.
