...
- [LWCite-2064] Kara, 2021, "Don't Bite the Bait: Phishing Attack for Internet Banking (E-Banking)", JDFSL 16(5). Repeatedly describes the WHOIS/IP-derived information as data "thought to belong to the attacker" rather than confirmed attacker identity.
