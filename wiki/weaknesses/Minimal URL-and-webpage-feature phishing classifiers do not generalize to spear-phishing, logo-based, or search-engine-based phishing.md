...
- [LWCite-2069] Abiodun, Sodiya, Kareem & Oladimeji, 2021, "Performance Assessment of some Phishing predictive models based on Minimal Feature corpus", JDFSL 16(5). The paper's own 13-feature minimal set is entirely URL/webpage-structural, and its literature review explicitly flags the same generalization gap (spear-phishing, logo-based, search-engine-based phishing) as a limitation of comparable prior studies using a similarly URL-centric feature scope.
